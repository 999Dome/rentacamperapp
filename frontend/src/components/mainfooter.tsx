        ...
        <div className="row gy-4">
          <div className="col-12 col-lg-4">
            <div className="d-flex align-items-center gap-2 mb-3">
              ...
              <span className="fs-4 fw-bold custom-font text-white">
                RENT-A-CAMPER
              </span>
            </div>
            <p className="text-white-50 small pe-lg-4">
              Dein zuverlässiger Partner für unvergessliche Wohnmobil-Abenteuer.
              Finde deinen Traum-Camper, miete flexibel und entdecke die
              Freiheit der Straße.
            </p>
          </div>
          <div className="col-6 col-lg-2 offset-lg-1">
            <h5 className="text-white mb-3 fs-6 text-uppercase fw-bold">
              Entdecken
            </h5>
