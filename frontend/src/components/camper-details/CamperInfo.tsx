            ...
            {features.length > 0 ? (
              features.map((f) => (
                <div className="col-12 col-sm-6">
                  <div className="d-flex align-items-center p-3 rounded-3 bg-light border">
                    <span className="text-custom-light-blue fw-bold fs-5 me-3">
                      ✓
                    </span>
                    <span className="fs-5 text-dark">
                      {(f as { features?: { name: string } }).features?.name ||
                        "Feature"}
                    </span>
                  </div>
                </div>
              ...
              <div className="col-12">
                <p className="text-muted fs-5">
                  Keine spezifischen Features aufgelistet
                </p>
              </div>
            )}
          </div>
          ...
          <ul className="list-group list-group-flush fs-5">
            <li className="list-group-item d-flex justify-content-between align-items-center px-0 py-3 border-bottom bg-transparent">
              ...
              <span className="fw-medium">
                {camper.length_cm || "-"} x {camper.width_cm || "-"} x{" "}
                {camper.height_cm || "-"} cm
              </span>
            </li>
            <li className="list-group-item d-flex justify-content-between align-items-center px-0 py-3 border-bottom bg-transparent">
              ...
              <span className="fw-medium">
                {camper.empty_weight_kg || "-"} / {camper.max_weight_kg || "-"}{" "}
                kg
              </span>
            </li>
            <li className="list-group-item d-flex justify-content-between align-items-center px-0 py-3 border-bottom bg-transparent">
              ...
              <span className="fw-medium">
                {camper.engine_power || "-"} PS /{" "}
                {camper.fuel_consumption || "-"}l/100km
              </span>
            </li>
            <li className="list-group-item d-flex justify-content-between align-items-center px-0 py-3 bg-transparent">
              <span className="text-muted">
                Anhängerkupplung (Anhängermaximalgewicht)
              </span>
              <span className="fw-medium">
                {camper.has_tow_hitch ? "Ja" : "Nein"} (
                {camper.max_towing_capacity_kg || "0"} kg)
              </span>
            </li>
          </ul>
        </div>
